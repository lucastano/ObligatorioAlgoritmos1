 ...
 * @author lucas
 */
public class ColaPedidosCerrados implements IColaPedidosCerrados {
    
    private NodoPedido inicio;
    private NodoPedido fin;
    private int cantidad;
    
     public ColaPedidosCerrados()
    {
     this.cantidad=0;
    }
    ...
    public void mostrarColaPedidosCerrados() {
        ...
        System.out.println("Cliente no tiene pedidos Cerrados");
        System.out.println("\n");
        }
        else{
            
           NodoPedido pedido=this.getInicio();
           System.out.println("Pedidos cerrados de "+pedido.getPedido().getCliente().getNombre());
           while(pedido!=null)
           {
               pedido.getPedido().mostrarProductoCantidad();
           pedido=pedido.getSig();
           }
